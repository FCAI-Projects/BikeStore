<?php require APPROOT . '/views/inc/header.php' ?>
  ...
  <div class="container">
    <h1 class="text-center mt-4 mb-5" style="color: #333">My products Order</h1>
    <div class="row mt-5">
      <table class="table mx-auto mt-5 text-center" style="width: 70%">
      ...
      <tbody>
        ...
        <?php foreach ($data['seller'] as $item): ?>
        <tr>
          <th><?= $item->productId ?></th>
          <th><?= $item->name ?></th>
          <th><?= $item->orderQuantity ?></th>
          <th>$<?= $item->price * $item->orderQuantity ?></th>
        </tr>
